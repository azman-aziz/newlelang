...
<head>
    ...
    <title>Selamat datang di <?= $judul;?></title>
    ...
    <!-- datatables-->
    <link href="<?= base_url() ?>vendor/datatables/dataTables.bootstrap4.min.css">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon ml-3 rotate-n-15">
                <i class="far fa-handshake"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Lelang<sup>keun!</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>admin/masyarakat">Masyarakat</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Logo -->
                    <h6 class="text-center">Wujudkan Lelang yang aman,nyaman serta halal</h6>
                    <!-- Topbar Navbar -->
